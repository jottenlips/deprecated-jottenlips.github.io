...
let posts =  [{
    ...
    content: [{
        ...
        format: "code",
        text: "brew install caskroom/cask/brew-cask
        ...
        format: "code",
        text: "mkdir programming // makes a folder called programming, you can name this whatever you\'d like.
        ...
        format: "p",
        text: "Think of a topic that interests you. I love music theory so I am going to write a simple function that tells me the fifth of any note.
        ...
        format: "p",
        text: "First this function makes our input note lowercase so when we get the property (note) of our object (notes and their corresponding fifths) it will match one of the objects keys (left hand side of the object). 
